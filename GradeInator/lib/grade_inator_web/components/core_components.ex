defmodule GradeInatorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GradeInatorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GradeInatorWeb.Gettext, "errors", msg, opts)
    end
  end
